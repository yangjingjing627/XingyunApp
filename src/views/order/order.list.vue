<template>
  <div class="order-list">
    <div class="order-list-content"
      ...
      <order-list-item v-for="item in list"
...
<script>
import orderListItem from './order.listItem.vue'
...
export default {
  ...
  methods: {
    ...
    async getList () {
      this.isReq = true
      let params = {}
      for (let item in this.listInfo.searchObj) {
        params[item] = this.listInfo.searchObj[item]
      }
